...
//２．データ登録SQL作成
$stmt = $pdo->prepare("SELECT * FROM kanri_db WHERE id=:id");
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">管理者情報</a>
                </div>
                        ...
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                  ...
                                  <h4 class="title">USER_ID：<?=$rs["name"]?></h4>
                                </div>
                                <p class="description text-center">ログインID：<?=$rs["lid"]?>
                                </p>
